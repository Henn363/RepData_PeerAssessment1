#Reproducible Reseach: Peer 1 Assessment
...
```{r Average_step, fig.height = 4, echo = TRUE}
...
The 5 minute interval with the most steps is interval `r Max_int[1,1]`
...
```
The total number of NA values is `r NA_values`
